...
export const LUMINARIES: Luminary[] = [
  ...
  },
  {
    ...
    formats: [
      { id: "review", label: "Portfolio Review", mins: 35, price: 2000, desc: "Screen-by-screen breakdown." },
      { id: "deep", label: "Strategy Session", mins: 50, price: 3500, desc: "Design leadership or systems." },
    ],
  },
  {
    handle: "aaditya-deshmukh",
    name: "Aaditya Deshmukh",
    short: "Aaditya",
    title: "UPSC AIR 4 · IAS & Policy Mentor",
    org: "Public Policy Fellow · ex-IAS",
    rating: 5.0,
    sessionsDone: 142,
    years: 8,
    responseTime: "~1h",
    priceFrom: 1900,
    tags: ["UPSC & Exams", "Public Policy", "Governance"],
    nextSlot: "Today · 8:00 PM",
    bio: "Cracked UPSC CSE with AIR 4. I mentor aspirants on prelims strategy, mains answer writing, optional subjects, and interview preparation.",
    provenance: [
      { label: "AIR 4 — UPSC Civil Services Exam", source: "Verified · DoPT Record", year: "2019" },
      { label: "Master in Public Policy", source: "Verified · Harvard Kennedy", year: "2022" },
      { label: "Mentored 40+ Top 100 Rankers", source: "Verified · Results Board", year: "2020–25" },
    ],
    formats: [
      { id: "quick", label: "Strategy & Roadmap", mins: 30, price: 1900, desc: "Subject choice, timetable, and study plan teardown." },
      { id: "deep", label: "Mains & Interview Prep", mins: 60, price: 3500, desc: "Detailed answer evaluation and mock interview." },
    ],
  },
  {
    handle: "prof-priya-sharma",
    name: "Prof. Priya Sharma",
    short: "Priya",
    title: "GATE AIR 1 · Physics & Math Tutor",
    org: "IISc Alum · Premier Exam Coach",
    rating: 4.9,
    sessionsDone: 198,
    years: 10,
    responseTime: "~2h",
    priceFrom: 1500,
    tags: ["GATE & JEE", "STEM Coaching", "Mentorship"],
    nextSlot: "Tomorrow · 6:00 PM",
    bio: "GATE AIR 1 and JEE Advanced mentor. I take 1:1 sessions on advanced physics, engineering math, and exam problem-solving speed techniques.",
    provenance: [
      { label: "AIR 1 — GATE Computer Science & Math", source: "Verified · IIT Board", year: "2017" },
      { label: "M.Tech — IISc Bangalore", source: "Verified · IISc", year: "2019" },
      { label: "10+ Years Competitive Exam Mentorship", source: "Verified · Faculty Council", year: "2015–25" },
    ],
    formats: [
      { id: "quick", label: "Doubt & Problem Solving", mins: 30, price: 1500, desc: "Complex problem breakdown & speed tricks." },
      { id: "deep", label: "Comprehensive Exam Roadmap", mins: 60, price: 2800, desc: "Full exam strategy, mock test analysis, subject plan." },
    ],
  },
  {
