  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          {/* Ambient Logo Halo (Blue to Lilac/Violet) */}
          <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
            <motion.div
              initial={{ scale: 0.8, opacity: 0 }}
              animate={{ scale: [0.8, 1.2, 1], opacity: [0.2, 0.5, 0.35] }}
              transition={{ duration: 2, repeat: Infinity, repeatType: "reverse" }}
              className="absolute left-1/2 top-1/2 h-[32rem] w-[32rem] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,rgba(62,111,232,0.35)_0%,rgba(110,91,240,0.25)_50%,transparent_70%)] blur-3xl"
            />
          </div>
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            <motion.div
              ...
              className="relative flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-to-br from-[#121626] to-[#18152e] p-4 shadow-[0_0_50px_rgba(110,91,240,0.35)] ring-1 ring-white/10"
            >
            ...
            <motion.div
              ...
              className="mt-8 h-[2.5px] rounded-full bg-gradient-to-r from-[#3E6FE8] via-[#5b64ed] to-[#6E5BF0]"
            />
          </div>
        </motion.div>
      )}
